'''
Author: szh
Date: 2023-03-04 10:02:32
LastEditors: szh
LastEditTime: 2023-03-04 11:11:49
Description: 
FilePath: /codet5_APPS/configs/train_configs.py
'''
import argparse
...
parser.add_argument('--save_dir', default='/home2/szh/Szh/codet5_APPS/outputs/save_model', type=str, help='path to save trained model checkpoints') 

# Dataloading
parser.add_argument('--train-path', default='/home2/szh/Szh/codet5_APPS/data/APPS/train', type=str, help='path to training data')
...
parser.add_argument('--grad-acc-steps', default=4, type=int, help='number of training steps before each gradient update')
