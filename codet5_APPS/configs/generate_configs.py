'''
Author: szh
Date: 2023-03-04 10:02:43
LastEditors: szh
LastEditTime: 2023-03-04 11:13:06
Description: 
FilePath: /codet5_APPS/configs/generate_configs.py
'''
import argparse

parser = argparse.ArgumentParser(description="Run a CodeT5 model to generate Python programs.")

parser.add_argument("-t","--test_path", default="/home2/szh/Szh/codet5_APPS/data/APPS/test", type=str, help='Path to test samples')
parser.add_argument("--output_path", default="/home2/szh/Szh/codet5_APPS/outputs/save_codes",type=str, help='Path to save output programs') 
parser.add_argument("--model_path", default="/home2/szh/Szh/codet5_APPS/outputs/save_model/checkpoint",type=str, help='Path of trained model') 
